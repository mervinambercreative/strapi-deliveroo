...
module.exports = {
  ...
  /**
   * Add relation to a/an dish record.
   *
   * @return {Object}
   */

  createRelation: async (ctx, next) => {
    return strapi.services.dish.addRelation(ctx.params, ctx.request.body);
  },

  /**
   * Update relation to a/an dish record.
   *
   * @return {Object}
   */

  updateRelation: async (ctx, next) => {
    return strapi.services.dish.editRelation(ctx.params, ctx.request.body);
  },

  /**
   * Destroy relation to a/an dish record.
   *
   * @return {Object}
   */

  destroyRelation: async (ctx, next) => {
    return strapi.services.dish.removeRelation(ctx.params, ctx.request.body);
  }
};
